...
For presentation capture, the app writes generic, paced, emoji-led updates for newly detected recordings to `<notes-checkout>/.voice-memo-automation/agent-demo.log`. This human-readable log is separate from JSONL telemetry and contains no memo content or identifiers.
